...
def _signed(body, author):
    ...
    three actually produced a given comment. `author` should be "script",
    the local model's name (config.OLLAMA_MODEL), or "claude"; whichever tier
    made the decision or wrote the substance being reported, not just
    whichever function happened to call the post."""
